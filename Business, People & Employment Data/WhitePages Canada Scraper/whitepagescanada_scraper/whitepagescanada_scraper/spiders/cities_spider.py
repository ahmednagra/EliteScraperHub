...
class SpiderSpider(Spider):
    ...
    def parse(self, response, **kwargs):
        # cities_urls = response.css('div:contains("Cities") + ul a::attr(href)').getall()  # Get the cities url from the website footer section
        cities_urls = ['https://whitepagescanada.ca/on/toronto/']
